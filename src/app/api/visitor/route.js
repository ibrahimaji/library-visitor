...
export const POST = async (req) => {
  try {
    ...
    return NextResponse.json({ message: "Terjadi masalah ketika membuat pengunjung", err }, { status: 500 })
  }
}
...
export const GET = async () => {
  try {
    ...
    return NextResponse.json({ message: "Tidak dapat menemukan pengunjung", err }, { status: 500 })
  }
}
